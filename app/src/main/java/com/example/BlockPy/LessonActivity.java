...
import androidx.appcompat.app.AppCompatActivity; import androidx.fragment.app.*;
import android.content.Intent; import android.os.*; import android.util.Log; import android.widget.Toast;
...
public class LessonActivity extends AppCompatActivity {
    ...
    private String lessonId; private Lesson currentLesson;
    ...
    protected void onCreate(Bundle sIS) {
        ...
        if(currentLesson==null) {
            Log.e(TAG,"Not found:"+lessonId);finish();return;
        }
